...

{
  wayland.windowManager.hyprland = {
    ...
    extraConfig = "
      ...
      env = XCURSOR_SIZE,24
      env = CONFIG_DIRECTORY,/home/totaltaxamount/.config
      env = XDG_DATA_HOME,$HOME/.local/share
      env = XDG_SCREENSHOTS_DIR,/home/totaltaxamount/Pictures/Screenshots
      ...
      decoration {
          ...
          col.shadow = rgb(88C0D0)
          col.shadow_inactive = rgb(4C566A)
      }
      ...
      bind = $mainMod, R, exec, rofi -show drun -theme Nord
      ...
      bind = CTRL SHIFT, Print, exec, grimblast copysave active
      ...
      bind = SUPER,XF86PowerOff, exec, systemctl poweroff
      binde = ,XF86PowerOff, exec, systemctl suspend
    ";
  };
}